...
class GR00TN15Config(PretrainedConfig):
    """GR00T N1.5 config. Do not use @dataclass here: HuggingFace PretrainedConfig is not a dataclass,
    and mixing them breaks field ordering (see dataclasses.TypeError on import)."""
